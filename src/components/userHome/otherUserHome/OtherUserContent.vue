    ...
    <div class="userContent">
        <div class="head">
            <span class="tab-group">
                <router-link :to="`/otherUserHome/${userId}/postList`" class="tab-link" active-class="active">文章</router-link>
                <span class="tab-number">{{ userHomeStore.postCount }}</span>
            </span>
            <span class="tab-group">
                <router-link :to="`/otherUserHome/${userId}/categoryList`" class="tab-link" active-class="active">专栏</router-link>
            ...
            <span class="tab-group">
                <router-link :to="`/otherUserHome/${userId}/likeList`" class="tab-link" active-class="active">点赞</router-link>
            </span>
            <span class="tab-group">
                <router-link :to="`/otherUserHome/${userId}/browseList`" class="tab-link" active-class="active">浏览</router-link>
            </span>
        </div>
...
<script lang="ts" setup name="OtherUserContent">
